  ...
  return (
    <PageWithNavbar>
      <div className="prose mx-auto my-8">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to DoggoZoomies LLC.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to FlowCraft, accessible from{' '}
              <a
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              ...
              market our products/services. Website usage data is captured using
              first and third-party cookies and other tracking technologies to
              determine the popularity of products/services and online activity.
              Additionally, we use this information for site optimization,
              fraud/security purposes, and advertising. For more information
        ...
        <ul>
          <li>By email: smistr61@gmail.com</li>
        </ul>
      </div>
      <Footer />
    </PageWithNavbar>

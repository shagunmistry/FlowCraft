...
import DiagramOrChartView from '../DiagramOrChartView'
...
export default function SharedDiagramInviteCodeForm({
  ...
  const hnadleSubmit = async (e: any) => {
    ...
    if (diagramData.type === 'Flow Diagram') {
      ...
      diagramContext.setTitle(diagramData.title)
      diagramContext.setDescription(diagramData.description)
      diagramContext.setType(diagramData.type)
    }
  }
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
        ...
        {canAccess &&
          diagramContext.type &&
          diagramContext.type === 'Flow Diagram' && (
